...
/**
 * WxSystemtrxnmemoId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class WxSystemtrxnmemoId implements java.io.Serializable {
	...
	/** default constructor */
	public WxSystemtrxnmemoId() {
	}

	/** full constructor */
	public WxSystemtrxnmemoId(Long bankorgId, String trxnSeq) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof WxSystemtrxnmemoId))
			return false;
		WxSystemtrxnmemoId castOther = (WxSystemtrxnmemoId) other;
