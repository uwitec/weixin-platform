...
public class ServerConfigFactory {
	private static Logger logger = Logger.getLogger(ServerConfigFactory.class);
	private static ServerConfigFactory clientConfigFactory = null;
	...
	public static ServerConfigFactory getInstance(){
		if(clientConfigFactory == null){
			clientConfigFactory = new ServerConfigFactory();
		}
