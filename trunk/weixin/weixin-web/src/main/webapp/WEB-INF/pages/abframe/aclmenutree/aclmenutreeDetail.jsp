...
<form name="form1" method="post" action="<%=request.getContextPath()%>/aclMenuTree/${detailTag==null?'add.action':'update.action'}"  id="form1">
    ...
    <tr class="form_top">
     ...
     <tr>
         ...
         <td align="left" class="l-table-edit-td">
             ...
             <%-- <input type="text" name="aclMenutree.id.nodeId" value="${aclMenutree.id.nodeId }"  id="d_nodeId" validate="{required:true,maxlength:20}" ${detailTag==null?'':'readonly'}/> --%>
             <sc:text name="aclMenutree.id.nodeId" id="d_nodeId" value="${aclMenutree.id.nodeId}" type="text" ltype="text" validate="{required:true,maxlength:20}" readonly="${detailTag==null?'':'readonly'}"></sc:text>
         </td>
     ...
     <tr>
        <td class="form_label"><fmt:message key="nodeName"/>:</td>
         <td align="left" class="l-table-edit-td">
              <input id="d_nodeName" type="text" name="aclMenutree.nodeName" value="${aclMenutree.nodeName }"  type="text" validate="{required:true,maxlength:10}"/>      
         </td>
       <td class="form_label"><fmt:message key="parentId"/>:</td>
         <td align="left" class="l-table-edit-td">
             <input name="aclMenutree.parentId" value="${aclMenutree.parentId }" type="text" id="d_parenId"  type="text" validate="{required:true,maxlength:20}"/>
         </td>
     </tr>
     <tr>
