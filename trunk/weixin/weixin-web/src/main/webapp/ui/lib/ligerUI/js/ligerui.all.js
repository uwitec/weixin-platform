...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            //加载中
            g.gridloading = $(".l-grid-loading:first", g.grid); //Dai 加的注释
            //调整列宽层 
        ...
        {
            this.gridloading.html(value); //Dai 添加的注释
        },
        ...
        {
         //   this.gridloading[show ? 'show' : 'hide'](); //Dai 加的注释
        },
...
(function ($)
{
    ...
    $.ligerui.controls.Tree.ligerExtend($.ligerui.core.UIComponent, {
        ...
        upgrade: function (treeNode)
        {
            ...
            {
                $(this).removeClass("l-note").addClass("l-expandable-close");
            });
            $(".l-note-last", treeNode).each(function ()
            {
                $(this).removeClass("l-note-last").addClass("l-expandable-close");
            });
        ...
        _getTreeHTMLByData: function (data, outlineLevel, isLast, isExpand)
        {
            ...
            for (var i = 0; i < data.length; i++)
            {
                ...
                if (g.hasChildren(o))
                {
                    if (isExpandCurrent) treehtmlarr.push('<div class="l-box l-expandable-close"></div>');
