...
return !(IsLongEnough(ClientSoWeakPassword.arguments[0], "6"));
	...
	function EvalPwd(Pwd) {
		//长度大于0是开始判断
		if (Pwd.length > 0) {
			if (ClientPerfectPassword(Pwd, gSimilarityMap, gDictionary)) {
			document.getElementById('soweak').className = 'pwd_perfect1';
			document.getElementById('weak').className = 'pwd_perfect1';
			document.getElementById('middleweak').className = 'pwd_perfect1';
            document.getElementById('middle').className = 'pwd_perfect1';
			document.getElementById('middlestrong').className = 'pwd_perfect1';
			document.getElementById('strong').className = 'pwd_perfect1';
			document.getElementById('perfect').className = 'pwd_perfect';
				PasswordStrenth = 7;  
			} else if (ClientStrongPassword(Pwd, gSimilarityMap,gDictionary)) {				
			document.getElementById('soweak').className = 'pwd_strong1';
			document.getElementById('weak').className = 'pwd_strong1';
			document.getElementById('middleweak').className = 'pwd_strong1';
            document.getElementById('middle').className = 'pwd_strong1';
			document.getElementById('middlestrong').className = 'pwd_strong1';
			document.getElementById('strong').className = 'pwd_strong';
			document.getElementById('perfect').className = 'pwd_default';
				PasswordStrenth = 6;
			} else if (ClientMiddleStrongPassword(Pwd, gSimilarityMap,gDictionary)) {				
			document.getElementById('soweak').className = 'pwd_middlestrong1';
			document.getElementById('weak').className = 'pwd_middlestrong1';
			document.getElementById('middleweak').className = 'pwd_middlestrong1';
            document.getElementById('middle').className = 'pwd_middlestrong1';
			document.getElementById('middlestrong').className = 'pwd_middlestrong';
			document.getElementById('strong').className = 'pwd_default';
			document.getElementById('perfect').className = 'pwd_default';
				PasswordStrenth = 5;
			} else if (ClientMiddlePassword(Pwd, gSimilarityMap,gDictionary)) {
			document.getElementById('soweak').className = 'pwd_middle1';
			document.getElementById('weak').className = 'pwd_middle1';
			document.getElementById('middleweak').className = 'pwd_middle1';
            document.getElementById('middle').className = 'pwd_middle';
			document.getElementById('middlestrong').className = 'pwd_default';
			document.getElementById('strong').className = 'pwd_default';
			document.getElementById('perfect').className = 'pwd_default';
				PasswordStrenth = 4;
			} else if (ClientMiddleWeakPassword(Pwd, gSimilarityMap,gDictionary)) {				
			document.getElementById('soweak').className = 'pwd_middleweak1';
			document.getElementById('weak').className = 'pwd_middleweak1';
			document.getElementById('middleweak').className = 'pwd_middleweak';
			...
			document.getElementById('soweak').className = 'pwd_weak1';
			document.getElementById('weak').className = 'pwd_weak';
			document.getElementById('middleweak').className = 'pwd_default';
            document.getElementById('middle').className = 'pwd_default';
			document.getElementById('middlestrong').className = 'pwd_default';
			document.getElementById('strong').className = 'pwd_default';
			document.getElementById('perfect').className = 'pwd_default';
				PasswordStrenth = 2;
		} else if (ClientSoWeakPassword(Pwd, gSimilarityMap,gDictionary)) {
			document.getElementById('soweak').className = 'pwd_soweak';
			...
			document.getElementById('soweak').className = 'pwd_default';
			document.getElementById('weak').className = 'pwd_default';
			document.getElementById('middleweak').className = 'pwd_default';
            document.getElementById('middle').className = 'pwd_default';
			document.getElementById('middlestrong').className = 'pwd_default';
