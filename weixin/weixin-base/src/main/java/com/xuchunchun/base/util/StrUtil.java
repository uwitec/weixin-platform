...
public class StrUtil {
	...
	public static String fill(String fillType,char fillChar,String content,int length){
		StringBuffer sb = new StringBuffer();
		int contentLength = strlen(content);
		int fillLength = length - contentLength;
		
		if("L".equalsIgnoreCase(fillType)){
	...
	public static String parseFiledName(String fieldName){
	 ...
	 * @return
	 */
	public static String formatLocalStr(String fileName, String fileType){
		Locale myLocale  =  Locale.getDefault();
		StringBuffer file = new StringBuffer();
		file.append("/WEB-INF/classes/");
		file.append(fileName.replaceAll("\\.", "\\\\"));
		file.append("_");
		file.append(myLocale.getLanguage());
		file.append("_");
		file.append(myLocale.getCountry());
		file.append(".");
